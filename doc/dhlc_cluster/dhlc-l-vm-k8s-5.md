# Control Host: `dhlc-l-vm-k8s-5`

## ⚙️ Naming

| **Hostname - Proxmox** | **Hostname - VM (shortname)** | **FQDN - Fully Qualifield Domain Name** |
|------------------------|-------------------------------|-----------------------------------------|
| dhlc-l-vm-k8s-5        | Sprind                         | k8s-5.local                            |

## 📌 Purpose
The virtual machine **`dhlc-l-vm-k8s-5`** serves as the **Kubernetes Master node** in the homelab cluster **downstream cluster**.
