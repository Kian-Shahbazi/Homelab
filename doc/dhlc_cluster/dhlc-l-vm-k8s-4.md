# Control Host: `dhlc-l-vm-k8s-4`

## ⚙️ Naming

| **Hostname - Proxmox** | **Hostname - VM (shortname)** | **FQDN - Fully Qualifield Domain Name** |
|------------------------|-------------------------------|-----------------------------------------|
| dhlc-l-vm-k8s-4        | Brigrand                       | k8s-4.local                            |

## 📌 Purpose
The virtual machine **`dhlc-l-vm-k8s-4`** serves as the **Kubernetes Master node** in the homelab cluster **downstream cluster**.
