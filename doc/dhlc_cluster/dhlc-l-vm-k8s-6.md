# Control Host: `dhlc-l-vm-k8s-6`

## ⚙️ Naming

| **Hostname - Proxmox** | **Hostname - VM (shortname)** | **FQDN - Fully Qualifield Domain Name** |
|------------------------|-------------------------------|-----------------------------------------|
| dhlc-l-vm-k8s-6        | Rindbrumm                      | k8s-6.local                            |

## 📌 Purpose
The virtual machine **`dhlc-l-vm-k8s-6`** serves as the **Kubernetes Master node** in the homelab cluster **downstream cluster**.
